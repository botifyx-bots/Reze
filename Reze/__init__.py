...
from Reze.config import Development as Config
...
LOGGER = _setup_reze_logging()

TOKEN = os.environ.get("Reze_TOKEN", Config.TOKEN)
OWNER_ID = int(os.environ.get("Reze_OWNER_ID", Config.OWNER_ID))

SESSION_NAME = "reze_main"
...
DOWN_PATH = "Reze/anime/downloads/"
HELP_DICT = dict()
...
LOGGER.info("[Reze] Reze Is Starting. | Bᴏᴛɪғʏx-Bᴏᴛ | Licensed Under MIT.")
plugins = dict(root="Reze/anime")
pyro_plugins = dict(root="Reze/pyro")
