...
from Reze import LOGGER, db
from Reze.custom_filter import InlineQuery
from Reze.custom_filter import callbackquery as Callback
from Reze.custom_filter import register as command
...
async def _quotly_api_(e):
    ...
    try:
        ...
        from Reze.utils.executors import run_in_thread
