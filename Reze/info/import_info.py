...
Reze allows you to import/export settings for chat, so you can quickly set up other chats using a preexisting template. Instead of setting the same settings over and over again in different chats, you can use this feature to copy the general configuration across groups.
