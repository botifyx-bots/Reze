...
from Reze import custom_filter, BOT_NAME, TOKEN, SUPPORT_CHAT, UPDATE_CHANNEL, START_PIC
from Reze.anime.bot import get_anime, get_recommendations, auth_link_cmd, logout_cmd, get_additional_info, code_cmd
from Reze.pyro.connection.connect import connectRedirect
from Reze.pyro.greetings.captcha.button_captcha import buttonCaptchaRedirect
from Reze.pyro.greetings.captcha.text_captcha import textCaptchaRedirect
from Reze.pyro.notes.private_notes import note_redirect
from Reze.pyro.rules.rules import rulesRedirect
from Reze.utils.decorators import *
from Reze.tele.clone import startpic
from Reze.utils.helper import AUTH_USERS, get_btns
from Reze.anime.bot import help_
...
async def starttt(client, message):
    if len(message.text.split()) == 1:
        if message.chat.type == ChatType.PRIVATE:
            from Reze.mongo.users_mongo import add_user
            ...
            buttons = [
                ...
                [InlineKeyboardButton("Source Code", url="https://github.com/botifyx-bots/Reze")],
            ]
            ...
            from Reze.mongo.users_mongo import add_chat
...
clone_help = """
Reze Clones are exact replicas of @Elf_Robot but with a personalized name and profile picture, ensuring enhanced performance and stability.
...
6. Send the API token to Reze via private message using `/clone [apitokenhere]`. Ensure to remove '[ ]'.
