...
from Reze.pyro.greetings.captcha.captcharules_button import ruleCaptchaButton
from Reze.pyro.greetings.utils.actions import failedAction, passedAction
from Reze.pyro.greetings.utils.captcha_text_gen import ButtonGen
from Reze.pyro.greetings.utils.random_string_gen import (
    RandomStringGen,
    mathCaptchaGen,
)
...
async def textCaptchaRedirect(client, message):
    ...
    if _match in ["text", "math"]:
        ...
        if new_user_id == user_id:
            ...
            CaptchaLoc = f"Reze/pyro/greetings/captcha/CaptchaDump/RezeCaptcha_text_{new_user_id}_{new_chat_id}.png"
            image = ImageCaptcha(
