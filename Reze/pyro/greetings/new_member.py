...
from Reze import BOT_ID, DEV_USERS, UPDATE_CHANNEL, SUPPORT_CHAT
from Reze import EVENT_LOGS as LOG_CHANNEL
from Reze import OWNER_ID, LOGGER
from Reze.helper.button_gen import button_markdown_parser
from Reze.helper.chat_status import isBotCan, isUserAdmin
from Reze.helper.welcome_helper.welcome_fillings import Welcomefillings
from Reze.helper.welcome_helper.welcome_send_message import SendWelcomeMessage
from Reze.mongo.welcome_mongo import (
    DEFAUT_WELCOME,
    GetCaptchaSettings,
    GetCleanWelcome,
...
from Reze.pyro.greetings.captcha import button_captcha, text_captcha
...
async def NewMemeber(client: Client, message: ChatMemberUpdated):
    try:
        ...
        # Reze's Special welcome for kami-samas!
        if is_owner(user_id):
            await client.send_message(
        ...
        # Reze's Special welcome for her onii-chan gang!
        if is_dev(user_id):
