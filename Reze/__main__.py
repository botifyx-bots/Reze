...
from Reze import LOGGER, anibot, create_indexes, pgram, telethn, TOKEN

from Reze.data import HELPABLE, IMPORTED, SUB_MODE, HIDDEN_MOD, USER_INFO
from Reze.info import ALL_MODULES
from Reze.pyro.nightmode import start_nightmode_scheduler
from Reze.utils.helper import j1 as helper_scheduler
from Reze.tele.clone import clone_start_up, shutdown_all_clones
from Reze.tele.backup import send as send_backup
from Reze.helper.http import close_http_clients
from Reze.mongo.users_mongo import WRITE_BUFFER
    ...
    for mode in ALL_MODULES:
        ...
        try:
            if module not in IMPORTED:
                ...
                imported_module = importlib.import_module("Reze" + module)
...
async def main():
    ...
    from Reze.utils.cache import start_cache_cleanup
    ...
    try:
        from Reze.functions.admins import start_admin_cache_task
    ...
    try:
        from Reze.tele.levels import start_levels_flush_task
    ...
    try:
        from Reze.tele.levels import flush_levels_buffers_now as _flush_levels
        await _flush_levels()
    except Exception as e:
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            from Reze.tele.chatbot import shutdown_chatbot
        ...
        try:
            from Reze.utils.cache import locks_cache, admin_cache, blocklist_cache, anonymous_admin_cache, approvals_cache
