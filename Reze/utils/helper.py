...
from Reze import DEV_USERS, DOWN_PATH, EVENT_LOGS, anibot, LOGGER
    ...
    async def wrapper(_, message: Message):
            ...
            try:
                ...
                if last_time and (current_time - float(last_time) < 1.2):
                    ...
                    if spam_count == 3:
                        ...
                        await clog("Reze", f"UserID: {user_id}", "SPAM")
                    ...
                    if spam_count >= 5:
                        ...
                        await clog("Reze", f"UserID: {user_id}", "BAN")
                        return
        ...
        try:
            ...
            try:
                ...
                await clog("Reze", e, "FAILURE", msg=message)
        ...
        if user_id in DEV_USERS or user_valid:
            ...
            try:
                ...
                try:
                    ...
                    await clog("Reze", e, "FAILURE", cq=c_q)
        else:
            if cqowner_is_ch:
                if not user_valid:
                    await c_q.answer(
