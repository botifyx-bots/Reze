...
from Reze.utils.data_parser import (
    AIRING_DB,
    ANIME_DB,
    CHAR_DB,
    GUI,
...
from Reze.utils.helper import get_user_from_channel as gcc
from Reze.utils.helper import rand_key
...
example: /anime Ao Haru Ride"""
    ...
    try:
        ...
        await clog("Reze", title_img, "LINK", msg=message)
...
example: /manga The teasing master Takagi san"""
    ...
    try:
        ...
        await clog("Reze", pic, "LINK", msg=message)
        await client.send_photo(gid, failed_pic, caption=finals_, reply_markup=buttons)
...
async def character_cmd(client: Client, message: Message, mdata: dict):
    ...
    try:
        ...
        await clog("Reze", img, "LINK", msg=message)
...
example: /airing Fumetsu no Anata e"""
    ...
    try:
        ...
        await clog("Reze", coverImg, "LINK", msg=message)
...
Or connect your channel with /aniconnect cmd if you are anonymous""",
    ...
    try:
        ...
        await clog("Reze", result[0], "LINK", msg=message)
        await client.send_photo(
...
This material is marked 18+ and not allowed in this group""",
    ...
    try:
        ...
        await clog("Reze", pic, "LINK", msg=cq)
        await cq.edit_message_media(
