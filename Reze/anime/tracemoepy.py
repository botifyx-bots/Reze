...
from Reze.anime.anilist import no_pic
from Reze.utils.data_parser import check_if_adult
from Reze.utils.db import get_collection
from Reze.utils.helper import clog, control_user, media_to_image, rand_key
from Reze.helper.http import get_aiohttp_session
...
async def trace_bekkkkkk(client: anibot, message: Message, mdata: dict):
    ...
    if dls_loc:
        ...
        try:
            ...
            await clog("Reze", e, "TRACEMOE", replied=replied)
            return
